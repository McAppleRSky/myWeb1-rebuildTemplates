...
//                        ,Paths.get(inputDir,hamlFilenameKey).toString()
    ...
    * */
    void ExternalProgramLauncher(String workdir, String program, String optionArg, String hamlInputDirArg, String htmlOutputDirArg){
...
//        ProcessBuilder procBuilder = new ProcessBuilder("ls","-l","/dev");
        ProcessBuilder processBuilder = new ProcessBuilder(program, optionArg, hamlInputDirArg, htmlOutputDirArg);
