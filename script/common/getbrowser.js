...
$(function() {
  switch(BrowserDetect.browser) {
    case 'MSIE': $("#datetime-bar").addClass("ie");
      break;
    case 'Chrome': $("#datetime-bar").addClass("chrome");
      break;
    case 'Firefox': $("#datetime-bar").addClass("firefox");
      break;
    case 'Opera': $("#datetime-bar").addClass("opera");
      break;
  }
});
